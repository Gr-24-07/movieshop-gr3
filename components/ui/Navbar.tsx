...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="hidden lg:flex h-28 bg-brand">
          ...
          <div className="flex space-x-5 items-center">
            {session?.user?.role === "ADMIN" && (
              <div className="flex items-center text-slate-200">
                <Link
                  className="hover:text-sky-300 transition-colors text-white rounded text-center"
            ...
            {session?.user?.role === "CUSTOMER" && (
              <Link
                className="flex items-center text-white px-3 py-1 rounded text-center"
            ...
            {session ? (
              <Link
                className="hover:text-sky-300 transition-colors text-white px-3 py-1 rounded text-center"
                href={"/"}
                onClick={() => signOut()}
              >
                Sign out
              ...
              <div className="flex space-x-5 items-center text-slate-200 login-links">
                <Link
                  className="flex items-center px-3 py-1 rounded-xl text-center"
                  href={"/signin"}
                >
                  Sign in
                </Link>
      ...
      <nav className="flex justify-between items-center h-28 lg:hidden bg-brand p-3">
